        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-sm border border-zinc-100 dark:border-zinc-800">
                ...
                <div class="mb-4">
                    ...
                    <span class="bg-emerald-100 dark:bg-emerald-950 text-emerald-800 dark:text-emerald-300 font-black px-3 py-1 rounded-full uppercase text-[10px]">Fully Completed</span>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <span class="block text-[10px] text-zinc-400 font-bold uppercase">Contact Person</span>
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-sm border border-zinc-100 dark:border-zinc-800">
                <h3 class="text-xs font-black text-primary dark:text-white uppercase tracking-tight mb-4 border-b border-zinc-100 dark:border-zinc-800 pb-2">Phase 2: Full Tournament</h3>
                <div class="space-y-3 text-xs font-semibold text-zinc-500 dark:text-zinc-400">
                    <div class="flex justify-between">
                        <span>Amount Paid:</span>
                        <span class="text-primary dark:text-white font-black">₦{{ number_format($registration->phase2_amount) }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Payment Status:</span>
