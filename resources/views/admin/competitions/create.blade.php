        ...
        <form action="{{ route('admin.competitions.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <select name="type" required
                        ...
                        <option value="novelty">Novelty/Friendly</option>
                    </select>
                </div>
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" rows="3"
                    class="w-full bg-zinc-50 dark:bg-zinc-800/50 border-none rounded-2xl px-6 py-4 font-bold text-primary placeholder:text-zinc-300 dark:text-zinc-500 focus:ring-2 focus:ring-secondary transition"></textarea>
            </div>
            ...
            <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-3xl p-6 space-y-4">
                ...
                <div class="space-y-4">
                    <div class="space-y-1">
                        ...
                        <input type="text" name="predictor_prize_1" placeholder="e.g. N100,000 + Trophy"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-1">
                            ...
                            <input type="text" name="predictor_prize_2" placeholder="e.g. N50,000"
                                class="w-full bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-xl px-4 py-3 font-bold text-primary dark:text-white focus:ring-2 focus:ring-secondary transition">
                        </div>
                        <div class="space-y-1">
                            ...
                            <input type="text" name="predictor_prize_3" placeholder="e.g. N20,000"
                                class="w-full bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-xl px-4 py-3 font-bold text-primary dark:text-white focus:ring-2 focus:ring-secondary transition">
                        </div>
                    </div>
                </div>
