        ...
        <form action="{{ route('admin.competitions.store') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" rows="3"
                    class="w-full bg-zinc-50 border-none rounded-2xl px-6 py-4 font-bold text-primary placeholder:text-zinc-300 focus:ring-2 focus:ring-secondary transition"></textarea>
            </div>
