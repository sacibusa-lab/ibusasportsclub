    ...
    <aside class="w-64 bg-primary text-white flex flex-col fixed h-full z-50 overflow-hidden">
        ...
        <nav class="flex-1 min-h-0 px-4 py-6 space-y-1 overflow-y-auto admin-nav-scrollbar">
            ...
            <div class="pt-6 pb-2 px-4">
                <span class="text-[10px] font-black text-white/30 uppercase tracking-widest">Analytics</span>
            </div>
            ...
            <a href="{{ route('admin.comments.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl transition {{ request()->routeIs('admin.comments.index') ? 'bg-secondary text-primary font-bold' : 'hover:bg-primary-light text-zinc-300' }}">
