                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end gap-2 text-zinc-300">
                                ...
                                <form action="{{ route('admin.matches.start', $match->id) }}" method="POST">
                                    @csrf
                                    <button type="submit" class="p-2 hover:text-emerald-500 transition" title="Start Match & Countdown">
                                ...
                                <div class="p-2 text-emerald-500 animate-pulse" title="Predictions Closing Soon">
